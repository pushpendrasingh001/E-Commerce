...
function HomeThis() {
  return (
   <>
   <div className='h-[518px] bg-red-green'>
...
<div className='w-[1300px] ml-[480px] mt-[30px]'>
<div className="grid grid-cols-4 gap-6">
         
         <div className="bg-white p-4 rounded-lg shadow-md">
             <div className="relative">
                 <img src="../../public/categories/sweater.png" alt="Gamepad" className="w-full h-32 object-top rounded"/>
         ...
         <div className="bg-white p-4 rounded-lg shadow-md">
             <div className="relative">
                 <img src="../../public/categories/cpu.png.png
